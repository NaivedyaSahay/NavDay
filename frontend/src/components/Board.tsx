...
const Board: React.FC<BoardProps> = ({ 
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 md:p-6 mt-6 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl shadow-2xl transition-all duration-300">
      {/* Board Header Grid */}
